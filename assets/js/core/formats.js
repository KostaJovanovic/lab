...
export const FULL_ANALYSIS = [
  ...
  { label: 'Office docs', exts: 'DOCX XLSX PPTX ODT ODS ODP DOC XLS PPT EPUB', tags: 'microsoft word excel powerpoint slides spreadsheet ebook epub viewer reader opendocument libreoffice openoffice odt ods odp legacy 97-2003 doc xls ppt binary ole2 page preview', desc: 'Open and read Microsoft Office documents - modern Word, Excel and PowerPoint (DOCX, XLSX, PPTX) and the legacy 97-2003 binaries (DOC, XLS, PPT) - plus OpenDocument text, spreadsheets and presentations (ODT, ODS, ODP) and EPUB e-books, shown as page previews with text, tables, sheets and slides.' },
...
export const IDENTIFICATION_CORE = [
  { label: 'Documents',       exts: 'PPSX ODG RTF Pages Numbers Keynote', tags: 'microsoft office powerpoint slideshow apple iwork libreoffice openoffice opendocument graphics google docs sheets slides rich text format wordpad', desc: 'Identify and read metadata from other office and open-document files: PowerPoint slideshows (PPSX), OpenDocument Graphics (ODG), Apple iWork (Pages, Numbers, Keynote), and Rich Text Format (RTF). Word, Excel, PowerPoint and the OpenDocument text/spreadsheet/presentation formats now open in a full page-preview viewer (see Office docs above).' },
